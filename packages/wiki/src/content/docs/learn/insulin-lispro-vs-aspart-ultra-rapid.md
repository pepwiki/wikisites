...
| Property | Insulin Lispro (Humalog) | Insulin Aspart (NovoRapid) |
|----------|-------------------------|---------------------------|
...
| Parameter | Lispro (Humalog) | Aspart (NovoRapid) |
|-----------|------------------|-------------------|
...
| Parameter | Lispro (Lyumjev) | Aspart (Fiasp) |
|-----------|------------------|----------------|
...
| Study | Comparison | Primary Outcome | Result |
|-------|------------|-----------------|--------|
...
| Study | Comparison | Nocturnal Hypoglycemia | Severe Hypoglycemia |
|-------|------------|----------------------|-------------------|
