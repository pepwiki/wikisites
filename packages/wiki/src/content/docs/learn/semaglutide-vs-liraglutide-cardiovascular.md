...
description: "Cardiovascular outcome comparison of semaglutide and liraglutide — LEADER, SUSTAIN, PIONEER, and SELECT trial results, MACE reduction, and cardiometabolic effects."
---
...
Liraglutide is a once-daily GLP-1 analogue with 94% sequence homology to native GLP-1:
...
Semaglutide is a once-weekly GLP-1 analogue with enhanced metabolic stability:
...
LEADER (Liraglutide Effect and Action in Diabetes: Evaluation of Cardiovascular Outcome Results) enrolled 9,340 patients with T2D and high CV risk:
...
SUSTAIN-6 (Trial to Evaluate Cardiovascular and Other Long-term Outcomes with Semaglutide in Subjects with Type 2 Diabetes) enrolled 3,297 patients with T2D and high CV risk:
...
SELECT enrolled 17,604 patients with overweight/obesity and established CV disease (without diabetes):
...
| Outcome | Liraglutide (LEADER) | Semaglutide (SUSTAIN-6) |
|---------|---------------------|------------------------|
...
The apparent superiority of semaglutide's MACE reduction (26% vs. 13%) must be interpreted cautiously:

1. **Trial design differences**: SUSTAIN-6 was shorter (2.1 vs. 3.8 years) with fewer events, potentially inflating the hazard ratio.
2. **Population differences**: LEADER enrolled sicker patients (63% with prior CV events vs. 85% in SUSTAIN-6).
3. **Duration of exposure**: Liraglutide's CV death benefit emerged gradually over 3+ years; semaglutide's trial may have been too short to demonstrate similar benefit.
4. **Dose differences**: SUSTAIN-6 used semaglutide 0.5–1.0 mg weekly; SELECT used 2.4 mg weekly — higher doses may produce greater CV benefit.

## Mechanisms of Cardioprotection

Both agents share overlapping cardioprotective mechanisms, with semaglutide potentially offering additional benefits:
...
| Consideration | Liraglutide | Semaglutide |
|---------------|-------------|-------------|
