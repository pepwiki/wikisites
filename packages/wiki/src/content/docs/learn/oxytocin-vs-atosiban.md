...
| Parameter | Oxytocin (Labor Induction) | Atosiban (Tocolysis) |
|-----------|---------------------------|----------------------|
...
| Tocolytic | Mechanism | Efficacy | Tolerability | Recommendation |
|-----------|-----------|----------|--------------|----------------|
