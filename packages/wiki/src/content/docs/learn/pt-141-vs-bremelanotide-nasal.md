...
| Property | PT-141 (Subcutaneous) | Bremelanotide (Vyleesi®) |
|----------|----------------------|--------------------------|
...
### Central Mechanism (MC3R/MC4R Activation)
...
### Bremelanotide Intranasal (Vyleesi)
...
### Vyleesi (Intranasal Bremelanotide)
