...
Semaglutide is a synthetic GLP-1 analogue with an amino acid sequence modified at positions 8 (Aib for Ala) and 34 (Arg for Lys), along with a C-18 fatty diacid chain attached via a linker to Lys26. The fatty acylation enables non-covalent albumin binding, extending the half-life to approximately 165 hours (7 days) — a dramatic improvement over native GLP-1's 2–3 minute half-life.
...
Tirzepatide is a linear 39-amino acid peptide with a C-20 eicosanedioic acid moiety conjugated at Lys-20. It engages both GIPR and GLP-1R with potent dual agonism, though with differential receptor selectivity (EC₅₀ for GIPR ~0.14 nM vs. GLP-1R ~0.18 nM).
...
The SURPASS program established tirzepatide's superiority across glycemic and weight endpoints:
...
The side effect profiles are broadly similar, reflecting shared GLP-1R-mediated effects on the gastrointestinal tract:
...
### Semaglutide 2.4 mg (STEP trials)
- Mean weight loss: 14.9% body weight at 68 weeks
...
- Mean weight loss: 20.9% body weight at 72 weeks
...
2. Frías JP, et al. "Tirzepatide versus semaglutide once weekly in patients with type 2 diabetes (SURPASS-2)." *NEJM* 2023;388:523-534.
