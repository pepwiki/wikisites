...
| Amino Acid | 3-Letter | 1-Letter | MW (Da) | α-COOH pKa | α-NH₃⁺ pKa | Side Chain pKa | pI | Hydrophobicity (Kyte-Doolittle) | Side Chain Classification |
|------------|----------|----------|---------|------------|-------------|----------------|----|--------------------------------|--------------------------|
...
| Amino Acid | Carbon Atoms | Branch Point | Key Feature |
|------------|-------------|--------------|-------------|
...
| Amino Acid | Ring System | pKa (Side Chain) | UV Absorbance |
|------------|-------------|------------------|---------------|
...
| Amino Acid | Functional Group | H-Bond Capacity | Key Feature |
|------------|-----------------|-----------------|-------------|
...
| Amino Acid | Charge at pH 7 | pKa | Role |
|------------|----------------|-----|------|
...
| Amino Acid | Modification | Effect |
|------------|-------------|--------|
...
| D-Amino Acid | Effect on Peptide |
|-------------|-------------------|
...
| Amino Acid | Abbreviation | MW (Da) | Feature |
|------------|-------------|---------|---------|
...
| Property | Vulnerable Amino Acids | Degradation Pathway |
|----------|----------------------|---------------------|
...
2. Kyte J, Doolittle RF. "A simple method for displaying the hydropathic character of a protein." *J Mol Biol* 1982;157:105-132.
