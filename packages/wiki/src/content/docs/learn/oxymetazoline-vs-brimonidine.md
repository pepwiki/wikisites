...
### Oxymetazoline: Vasoconstriction
...
| Parameter | Oxymetazoline | Brimonidine |
|-----------|---------------|-------------|
...
| Feature | Oxymetazoline | Brimonidine |
|---------|---------------|-------------|
...
| Factor | Oxymetazoline | Brimonidine |
|--------|---------------|-------------|
...
<script is:inline type="application/ld+json">
{
  ...
  "@type": "Drug",
  "name": "Oxymetazoline",
  "description": "Alpha-adrenergic agonist for nasal congestion and facial erythema",
...
<script is:inline type="application/ld+json">
{
  ...
  "@type": "Drug",
  "name": "Brimonidine",
  "description": "Selective alpha-2A adrenergic agonist for glaucoma and rosacea",
  "drugClass": "Alpha-2 adrenergic agonist",
  "chemicalFormula": "C11H16BrN5"
}
</script>
