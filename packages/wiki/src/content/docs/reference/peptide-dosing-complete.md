...
| Agent | Starting Dose | Target Dose | Frequency | Status |
|-------|--------------|-------------|-----------|--------|
...
### Pramlintide (Symlin) — Type 1/2 Diabetes
...
| Insulin | Onset | Peak | Duration | Starting Dose |
|---------|-------|------|----------|---------------|
...
### Octreotide (Sandostatin) — Acromegaly/NET
...
### Nesiritide (Natrecor) — Acute Heart Failure
...
| Peptide | Mild (eGFR 60–89) | Moderate (eGFR 30–59) | Severe (eGFR <30) |
|---------|-------------------|----------------------|-------------------|
...
| Peptide | Mild (Child-Pugh A) | Moderate (B) | Severe (C) |
|---------|---------------------|--------------|------------|
