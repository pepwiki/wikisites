...
description: "Signal peptides are short N-terminal sequences that direct newly synthesized proteins to the endoplasmic reticulum for secretion or membrane insertion."
status: "published"
...
- **S**RP binds the signal peptide
- **H**ydrophobic helix spans the membrane
- **A**lignment with SRP receptor
- **R**ibosome docks on translocon
- **P**eptide is cleaved by signal peptidase
