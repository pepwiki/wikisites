...
description: "GIP is an incretin hormone that enhances glucose-stimulated insulin secretion and forms the basis of dual agonist therapies alongside GLP-1 receptor activation."
status: "published"
...
- **G**astric acid inhibition (original function)
- **I**nsulin potentiation (incretin effect)
- **P**ancreatic beta cell survival

- **G**lucose-dependent action
- **L**ipid storage in adipose tissue
- **U**ptake of fatty acids
- **C**AMP signaling via GIPR
- **O**steoblast stimulation in bone
- **S**ynaptic plasticity in brain
- **E**nergy homeostasis regulation
