...
1. **Histidine** acts as a general base, abstracting a proton from serine's hydroxyl group
2. The activated **serine** oxygen attacks the carbonyl carbon, forming an acyl-enzyme intermediate
3. **Aspartate** orients histidine and stabilizes the positive charge that develops
4. Water hydrolyzes the acyl-enzyme intermediate, releasing products
