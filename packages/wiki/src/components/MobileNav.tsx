...
export default function MobileNav(props: MobileNavProps) {
  ...
  return (
    <nav class="lg:hidden" aria-label="Mobile navigation">
      <button
        type="button"
        class="p-2 text-slate-600 dark:text-slate-400 hover:text-[#0f766e] dark:text-[#2dd4bf] focus:outline-none focus:ring-2 focus:ring-[#0D9488] rounded"
                ...
                <a
                  ...
                  class={`block py-2 text-sm font-medium transition-colors ${
                    props.currentPath.startsWith(link.href)
                      ...
                      : "text-slate-600 dark:text-slate-400 hover:text-[#0f766e] dark:text-[#2dd4bf]"
                  }`}
