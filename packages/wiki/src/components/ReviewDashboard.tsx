...
export default function ReviewDashboard(props: ReviewDashboardProps) {
  ...
  return (
    <div class="max-w-2xl mx-auto">
      ...
      />
      {/* Stats bar */}
      <div class="flex items-center justify-between mb-6 p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800" aria-label="Review session statistics">
        <div class="text-center px-4">
          <div class="text-2xl font-bold text-[#0f766e] dark:text-[#2dd4bf]">{stats().total}</div>
        ...
        <div class="text-center px-4">
          <div class="text-2xl font-bold text-[#0f766e] dark:text-[#2dd4bf]">
        ...
        <Show when={currentCard() && currentCard()!.scheduledDays > 0}>
          <div class="text-center px-4 border-l border-slate-200 dark:border-slate-700">
            <div class="text-2xl font-bold text-[#0f766e] dark:text-[#2dd4bf]">{currentCard()!.scheduledDays}d</div>
      ...
      <Show when={sessionComplete()}>
        <div class="text-center py-12 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800">
          ...
          <button
            type="button"
            class="px-6 py-3 bg-[#0f766e] text-white rounded-full font-medium hover:bg-[#0f766e]/90 transition-colors"
