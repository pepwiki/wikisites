...
const PARAMS = {
  ...
  w: [
    0.4072, 1.1829, 3.1262, 15.4722,   // Initial stability weights
    7.2114, 0.4537, 0.9691, 0.0230,    // Difficulty weights
    1.4372, 0.3616, 0.2276, 3.4295,    // Stability after review weights
  ],
} as const;
